...
$link="ssa/ptma_opcd/ptfma_activar_cuenta.php?var=$var_encode";
	$body = '
<html>
	<head>
...
$mail->SetFrom('ecosheys@gmail.com', 'Sistema Secretaria de Salud');
...
$mail->MsgHTML($body);
  $mail->Send();
  echo '<script> alert("Revisar Correo para activar cuenta"); location.href="../index.php"; </script>';
